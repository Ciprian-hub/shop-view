  ...
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
    ...
    <table class="table-auto w-full">
      ...
      <tr>
        ...
        <TableHeaderCell field="firstName" :sort-field="sortField" :sort-direction="sortDirection">
          First Name
        </TableHeaderCell>
        <TableHeaderCell field="lastName" :sort-field="sortField" :sort-direction="sortDirection"
...
import {CUSTOMERS_PER_PAGE, USERS_PER_PAGE} from "../../constants";
